...
public final class SequenceUtil {
    ...
    public static Long createInfoSpecialId() {
        return SeqUtil.getNewId(
                SequenceCodeConstants.UserSequenceCode.UC_SPECIAL_INFO$INFO_SPECIAL_ID$SEQ);
    }
    ...
    public static String createPhoneSeqId() {
        return SeqUtil.getNewId(SequenceCodeConstants.UserSequenceCode.UC_USER$USER_ID$SEQ,
                7);
    }
}
