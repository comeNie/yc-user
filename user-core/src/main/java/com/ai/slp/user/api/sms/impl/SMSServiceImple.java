package com.ai.slp.user.api.sms.impl;
...
import com.ai.slp.user.api.sms.interfaces.ISmsServicesSV;
import com.ai.slp.user.api.sms.param.SMData;
import com.ai.slp.user.api.sms.param.SMDataInfoNotify;
import com.ai.slp.user.service.business.interfaces.ISmsBusiSV;
import com.ai.slp.user.vo.SMSInputVo;
import com.alibaba.dubbo.config.annotation.Service;

@Service
@Component
public class SMSServiceImple implements ISmsServicesSV {
	
	@Autowired
	private ISmsBusiSV sMSSvImpl;
