package com.ai.yc.user.api.ucuserphonebooks.interfaces;
...
import com.ai.yc.user.api.ucuserphonebooks.param.UcTelGroupMantainReq;
import com.ai.yc.user.api.ucuserphonebooks.param.UcTelGroupQueryReq;
import com.ai.yc.user.api.ucuserphonebooks.param.UcTelGroupQueryResp;
import com.ai.yc.user.api.ucuserphonebooks.param.UcUserPhonebooksBatchAddReq;
import com.ai.yc.user.api.ucuserphonebooks.param.UcUserPhonebooksBatchAddResp;
import com.ai.yc.user.api.ucuserphonebooks.param.UcUserPhonebooksBatchDeleteReq;
import com.ai.yc.user.api.ucuserphonebooks.param.UcUserPhonebooksModifyReq;
import com.ai.yc.user.api.ucuserphonebooks.param.UcUserPhonebooksQueryReq;
import com.ai.yc.user.api.ucuserphonebooks.param.UserPhonebook;
