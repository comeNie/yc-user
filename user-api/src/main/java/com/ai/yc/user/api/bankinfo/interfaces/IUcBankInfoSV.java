package com.ai.yc.user.api.bankinfo.interfaces;
...
import com.ai.yc.user.api.bankinfo.param.InsertBankInfoRequest;
import com.ai.yc.user.api.bankinfo.param.QueryBankInfoRequest;
import com.ai.yc.user.api.bankinfo.param.QueryBankInfoResponse;
import com.ai.yc.user.api.bankinfo.param.QueryBankInfoSingleRequest;
import com.ai.yc.user.api.bankinfo.param.QueryBankInfoSingleResponse;
import com.ai.yc.user.api.bankinfo.param.UpdateBankInfoRequest;
