package com.ai.yc.user.api.favorite.interfaces;
...
import com.ai.yc.user.api.favorite.param.DeleteFavoriteListRequest;
import com.ai.yc.user.api.favorite.param.InsertUserFavoriteRequest;
import com.ai.yc.user.api.favorite.param.UpdateFavoriteRequest;
import com.ai.yc.user.api.favorite.param.UserFavoriteRequest;
import com.ai.yc.user.api.favorite.param.UserFavoriteResponse;
